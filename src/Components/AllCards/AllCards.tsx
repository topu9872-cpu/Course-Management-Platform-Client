      ...
      >
        ...
        <div className="px-1 flex flex-col grow">
          ...
          <Link
            ...
            className="mt-auto text-center w-full py-2 rounded-lg bg-gray-50 text-[11px] font-bold text-gray-700 group-hover:bg-blue-600 group-hover:text-white transition-colors"
          >
            View Details
          </Link>
        </div>
